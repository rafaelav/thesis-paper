...
can be seen in Fig.~\ref{}. The fact that the average value of the real entropy
for the selected user is around $ $ means that, in reality we the uncertainty
about where a user will be traveling to next is $2^{} = $ locations. These
findings show that, the users we have been observing do not randomly choose
their future locations, but in fact, their locations are well established by
restrictions such as hours or days at which they need to be at work, or school
as well as other patterns that govern most of the times our decisions.
