...
Due to the using cross validation in order to determine the approximate number
...
%The present work proves that the exploration of human mobility is currently
% just at the beginning. Despite the numerous previous projects that have approached
